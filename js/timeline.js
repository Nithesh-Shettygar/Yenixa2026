...
const events = [
    ...
    { thematic: "Soul In Focus", name: "Photo/Videography", participants: "Solo", category: "Arts", color: "#05D0FF", desc: "Soul in Focus is a creative media competition designed to capture the spirit, emotions, and vibrant moments of Yenixa Fest through Photography and Cinematic Videography.", logo: "../assets/logos/photo.png" },
    ...
    { thematic: "Re-Coded Bits", name: "E-Sports Arena", participants: "Team (2)", category: "Gaming", color: "#FFAC72", desc: "Prepare for ultimate digital dominance in our Esports Arena, featuring high-octane showdowns exclusively on mobile platforms. Dominate the battlefield in our BGMI 2v2 tournament, where you'll have the chance to showcase elite gaming skills, tactical precision, and mobile mastery.", logo: "../assets/logos/esports.png" },
